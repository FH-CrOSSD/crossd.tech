...
​As it has been quite some time since our [first blog post](https://www.netidee.at/crossd/introducing-crossd), which introduced our envisioned system architecture, we want to give you a look at our current system.

## CrOSSD Cluster

Behold, here is our revised system architecture:

![](/uploads/Software_stack.jpg)
