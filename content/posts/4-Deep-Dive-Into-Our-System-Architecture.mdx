...
​As it has been quite some time since our [first blog post](https://crossd.tech/post/1-Introducing-CrOSSD), which introduced our envisioned system architecture, we want to give you a look at our current system.
