...
export const HeroImg = ({ data, parentField }) => {
  ...
  return (
    <Section color={data.color}>
      ...
      >
        <div className="row-start-2 lg:row-start-1 lg:col-start-1 lg:col-end-2 text-center lg:text-left">
          {data.tagline && (
            <h2
        ...
        {data.image && (
          <div
            ...
            className="row-start-1 flex justify-center lg:col-start-2 lg:col-end-4"
          >
            <img
...
export const heroImgBlockSchema: TinaTemplate = {
  name: "heroImg",
  label: "HeroImg",
  ui: {
